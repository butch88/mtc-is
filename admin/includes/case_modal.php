    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>ADD NEW CASE CATEGORY</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="case_save.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="form-row">
							<div class="col-md-12">
								...
								<input class="form-control" name="case_category" id="case_category" type="text" style="text-transform: uppercase;">							
                            </div>					
						</div>
					</div>
          	</div>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="case_edit.php" enctype="multipart/form-data">

					<div class="form-group">
						<div class="form-row">
							<div class="col-md-12">
								<input class="form-control" name="edit_case_id" id="edit_case_id" type="hidden" style="text-transform: uppercase;" readonly>
					...
					<div class="form-group">
						<div class="form-row">
							<div class="col-md-12">
								<label for="division_name">Case Category</label>											
									<input class="form-control" name="edit_case_category" id="edit_case_category" type="text" style="text-transform: uppercase;">	                  
